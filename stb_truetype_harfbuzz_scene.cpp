...
void STB_TrueTypeHarfbuzzScene::Tick(const Context &context) {
  ImGui::Begin("Menu");
  ...
  DrawTextHarfbuzz(buffer, color, 300, 300, fontInfo, scale, hb_font,
                   context.renderer);
}

void STB_TrueTypeHarfbuzzScene::Cleanup(const Context &context) {
